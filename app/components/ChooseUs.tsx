...
<div className=" bg-[#f5f2fc] w-full items-center justify-center overflow-hidden transition-transform ">
   ...
   <div className="">
     ...
     Why Choose Us
      ...
      <p className="text-center justify-center mr-16 ml-16 text-2xl font-sans font-semibold text-[#253d4e]">
        ...
        <p className="p-2 text-center justify-center mr-16 ml-16 text-2xl font-sans font-semibold text-[#253d4e]">
   ...
   <div className="">
   <img className=" lg:mt-8 ml-6 lg:ml-4 " src="img/icon/care2.svg" alt="bg" /> 
   ...
   <div className="">
   <img className=" lg:mt-8 ml-6 lg:ml-0 " src="img/icon/team2.svg" alt="bg" /> 
   ...
   <div className="">
   <img className=" lg:mt-8 ml-6 lg:ml-0 " src="img/icon/mind2.svg" alt="bg" /> 
   ...
   <div className="">
   <img className=" lg:mt-8 ml-6 lg:ml-0 " src="img/icon/care2.svg" alt="bg" /> 
  ...
  <img className="" src="img/icon/partner/arrow.svg" alt="bg" /> 
  </p>
  
   <p className="w-full max-sm:hidden">
   <img className="" src="img/icon/partner/avianca.svg" alt="bg" /> 
   </p>
   
   <p className="w-full lg:block md:block">
   <img className="" src="img/icon/partner/envato.svg" alt="bg" />
    </p> 
   
    <p className="w-full hidden lg:block">
   <img className=" " src="img/icon/partner/olinski.svg" alt="bg" />
    </p> 
   
    <p className="w-full hidden lg:block md:block">
   <img className="" src="img/icon/partner/ozgeo.svg" alt="bg" />
    </p> 
   
    <p className="w-full hidden lg:block">
   <img className="" src="img/icon/partner/xidex.svg" alt="bg" /> 
   </p>
