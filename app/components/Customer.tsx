...
function Customer(){
     return (
        <>
           ...
           <div className=" lg:mb-10 bg-white w-full items-center justify-center overflow-hidden transition-transform ">
  ...
  <div className="bg-[#f3f3f3]  mt-4 flex  mb-8 max-md:flex-wrap lg:w-full mx-4 lg:ml-0 lg:mr-4 rounded-lg justify-between overflow-hidden sticky cursor-pointer">
  
     {/* 1 st */}
     <div className=" w-full flex justify-center items-center sticky">
      <div className=" p-8 ">
        <div className="flex">
        <Image width={150} height={150} src="/img/icon/truspilot.svg" alt="" /> <span className="mt-3 ml-3 font-semibold">Rating</span>
        </div>
    ...
    {/* 2 nd */}
     ...
     <Image width={130} height={130} className=" absolute" src="/img/icon/total-review-star.svg" alt="" />
     ...
     <div className=" w-full flex justify-center items-center lg:mr-8 sticky">
      ...
      {/* total-review-star.svg */}
        <div className="flex">
        <Image width={120} height={120} src="img/icon/google.svg" alt="" /> <span className="mt-2 ml-3 font-semibold">Rating</span>
        </div>
    ...
    <div className="flex size-full mb-12 mt-16 max-sm:flex-wrap max-md:flex-wrap items-center justify-center overflow-hidden sticky  cursor-pointer bg-[#fbfbfb]">
      ...
      {/* left-quat.svg */}
      {/* right-quat.svg */}
    <div className="w-full mx-6 lg:mx-6 md:ml-1 md:mr-0 mb-8 lg:mb-0 bg-white">
  ...
  <div className="w-full mx-6  lg:mx-6  md:mx-1 mb-8 lg:mb-0  ">
    ...
    <div className=" flex justify-between">
        ...
        <p className="font-mono tracking-tight justify-center items-center text-center text-gray-700 dark:text-gray-400 cursor-text my-2">
        Pellentesque maximus augue orci, quisdal andosp Pellentesque maximus augue orci, quisoki congue Nullam egestas, nisi id mollis elementum.
        </p>
        <div className=" flex justify-between">
          <img className="" src="img/icon/h2-testimonial-vec-left.svg"  alt="" />
